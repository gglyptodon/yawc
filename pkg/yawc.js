...
* @returns {string}
*/
export function showAttemptsRes() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.showAttemptsRes(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
...
export function getAttemptsRemaining() {
    const ret = wasm.getAttemptsRemaining();
    return ret;
}
...
* @returns {boolean}
*/
export function getKbUsed(character) {
    const ret = wasm.getKbUsed(character.codePointAt(0));
    return ret !== 0;
}
...
* @returns {boolean}
*/
export function getKbIncorrect(character) {
    const ret = wasm.getKbIncorrect(character.codePointAt(0));
    return ret !== 0;
}
...
* @returns {boolean}
*/
export function getKbCorrect(character) {
    const ret = wasm.getKbCorrect(character.codePointAt(0));
    return ret !== 0;
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('yawc_bg.wasm', import.meta.url);
    }
    const imports = getImports();
